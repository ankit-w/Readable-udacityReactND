...
import { fetchAllPosts, votePost, deletePost } from './postActionCreators'
...
class PostDetail extends Component {
  ...
  render() {
    const { post, votePost, comments, fetchAllPosts } = this.props
    if(!post) {
          ...
          <div className="post" key={post.id}>
            <div className="post-description">
              ...
              <div className="post-likes">
                <img src={ThumbsUp} width="22" height="22" onClick={() => {
                  votePost(post.id, "upVote")
                  fetchAllPosts()
                }} />
                <img src={ThumbsDown} width="22" height="22" onClick={() => {
